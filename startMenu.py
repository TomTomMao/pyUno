...
if __name__ =="__main__":
    ...
    pygame.display.set_caption("Choose the number of battle robots - Press 2,3,4,5,6,7")
    font = pygame.font.Font(None, 60)
    #font = pygame.font.Font('/Users/lizongzhe/Desktop/Nottingham/pythonProject/coursework/HFPuff/HFPuff-2.ttf', 70)
    GREEN = (0, 255, 0)
    BLUE = (0, 0, 255)
    BLACK = (0, 0, 0)
    smz=StartMenuZZ(screen,font)
    num_player=smz.starmenurender()
    abcrender=XXXRenderABC(screen,font,num_player)
    abcrender.xxrender()
    pygame.display.update()